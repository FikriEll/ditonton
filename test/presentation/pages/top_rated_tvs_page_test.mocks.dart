...
import 'package:ditonton/domain/usecases/get_top_rated_tvs.dart' as _i2;
...
class _FakeTopRatedTvsState_1 extends _i1.SmartFake
    implements _i3.TopRatedTvsState {
  _FakeTopRatedTvsState_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockTopRatedTvsCubit extends _i1.Mock implements _i4.TopRatedTvsCubit {
  ...
  _i3.TopRatedTvsState get state => (super.noSuchMethod(
        ...
        returnValue: _FakeTopRatedTvsState_1(
          this,
          Invocation.getter(#state),
        ),
